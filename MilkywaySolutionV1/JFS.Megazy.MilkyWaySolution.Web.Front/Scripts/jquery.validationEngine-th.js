        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "date": {                    
			        ...
			        "alertText": "* วันที่ไม่ถูกต้อง, ต้องเป็นรูปแบบ วัน-เดือน-ปี"
                },
                "ipv4": {
                ...
                "password": {
                    ...
                    "alertText": "* อักษรพิเศษ $@!%*?& ตัวพิมพ์ใหญ่ ตัวพิมพ์เล็ก ตัวเลข ความยาวไม่น้อยกว่า 8 ตัวอักษร"
                },
                ...
                "selectOne": {
                    "func": function (field, rules, i, options) {
                        return (field.prop('selectedIndex') == 0) ? false : true;
                    },
                    "alertText": "* กรุณาเลือก"
                },
                "projectcode": {
                    "regex": /^([a-zA-Z0-9]{1,4})-\d{1,5}$/,
                    "alertText": "* รหัสโครงการไม่ถูกต้อง"
                }
            };
