...
namespace JFS.Megazy.MilkyWaySolution.Engine.Helpers
{
    public static class Utility
    {
        ...
        //#region IMAGE
        //public void SaveProfile(string base64Img, int userID)
        //{
        //    try
        //    {
        //        Image image = Base64ToImage(base64Img.Replace("data:image/jpeg;base64,", ""));
        //        string path = GetProfilePath();
        //        //Image profileL = Resize(image, 200, 200);
        //        //profileL.Save(path + userID + ".png");

        //        //Image profileS = Resize(image, 32, 32);
        //        //profileS.Save(path + userID + ".png");

        //        Image profile = image;
        //        profile.Save(path + userID + ".png");
        //    }
        //    catch (Exception ex)
        //    {
        //        DalBase.ExceptEngine.KeepLogOnly(CSystems.ProcessID, ex);
        //        SaveProfileDefault(userID);
        //    }

        //}
        //public void SaveImgCate(string base64Img, string name)
        //{
        //    try
        //    {
        //        Image image = Base64ToImage(base64Img.Replace("data:image/jpeg;base64,", ""));
        ...
        //}
        //public void SaveProfileSocial(string resource, string socialName, int userID)
        //{
        //    try
        //    {
        //        Image image = null;
        ...
        //        {
        //            string url = "http://graph.facebook.com/" + resource + "/picture?type=large";
        ...
        //        string path = GetProfilePath();
        //        DalBase.ExceptEngine.KeepLogOnly(CSystems.ProcessID, new Exception("path:" + path));
        ...
        //}
        //public void SaveProfileDefault(int userID)
        //{

        //    string sourceImagePath = GetProfilePath() + "0.png";
        //    Image socialImageProfile = Image.FromStream(WebRequest.Create(sourceImagePath).GetResponse().GetResponseStream());
        //    string path = GetProfilePath();
        //    //Image profileL = Resize(socialImageProfile, 200, 200);
        //    //profileL.Save(path + userID + ".png");

        //    //Image profileS = Resize(socialImageProfile, 32, 32);
        //    //profileS.Save(path + userID + ".png");

        //    Image profile = socialImageProfile;
        //    profile.Save(path + userID + ".png");
        //}
        ...
        //private Image Resize(Image sourceImage, int newWidth, int newHeight)
        //{

        //    //Image newThumbImage = sourceImage;
        //    int width = 0;
        //    int height = 0;
        //    float positionx = 0;
        //    float positiony = 0;
        //    if (sourceImage.Width > newWidth || sourceImage.Height > newHeight)
        //    {
        ...
        //        //graphics.FillRectangle(new SolidBrush(System.Drawing.Color.White), 0, 0, newWidth, newHeight);

        //        if ((newHeight - height) < 0)
        //        {
        //            positiony = (height - newHeight) / 2;
        //        }
        //        else if ((newHeight - height) != 0)
        //        {
        //            positiony = (newHeight - height) / 2;
        //        }
        //        if ((newWidth - width) < 0)
        //        {
        //            positionx = (width - newWidth) / 2;
        //        }
        //        else if ((newWidth - width) != 0)
        //        {
        //            positionx = (newWidth - width) / 2;
        //        }
        //        //draw the image into the target bitmap

        //        graphics.DrawImage(sourceImage, positionx, positiony, width, height);
        ...
        //{
        //    Uri uri = new Uri(url);
        //    //https://lh5.googleusercontent.com/-g2um_gEEmVs/AAAAAAAAAAI/AAAAAAAAEjo/_4hRIB4WhX8/s96-c/photo.jpg
        //    //"http://graph.facebook.com/" + socailID + "/picture?type=large"
        ...
        //    //{
        //    //    IWebProxy proxy = new WebProxy("203.156.63.18", 3128);
        //    //    Request.Proxy = proxy;
        //    //}

        //    Exception exStartSaveImgProfile = new Exception("Start GetImageFromUrl Success = " + uri);
        //    DalBase.ExceptEngine.KeepLogOnly(CSystems.ProcessID, exStartSaveImgProfile);

        //    try
        //    {
        //        using (Response = (HttpWebResponse)(WebResponse)Request.GetResponse())
        //        {
        //            returnImg = Image.FromStream(Response.GetResponseStream());

        //            Exception exSaveImgProfile = new Exception("GetImageFromUrl Success = " + uri);
        //            DalBase.ExceptEngine.KeepLogOnly(CSystems.ProcessID, exSaveImgProfile);

        //        }
        //    }
        //    catch (Exception ex)
        //    {
        //        Exception exCannotSaveImgProfile = new Exception("Cannot GetImageFromUrl = " + uri);
        //        DalBase.ExceptEngine.KeepLogOnly(CSystems.ProcessID, exCannotSaveImgProfile);
        //    }
        ...
        //public string DecryptMd5(string toDecrypt)
        //{
        //    byte[] hash;
        //    using (MD5 md5 = MD5.Create())
        //    {
        ...
        public static string IncomeUnitThai(this string input)
        {
            string incomeUnit = "";
            if (input != null)
            {
        ...
        /// <param name="dt">Datetime คศ</param>
        /// <returns></returns>
        public static string ConvertDateToENYYYYMMDDString(DateTime dt)
        {
            return DateValidateInput(dt) ? dt.ToString("yyyy-MM-dd", CultureInfo.CreateSpecificCulture("en-US")) : "";
        }
        /// <summary>
