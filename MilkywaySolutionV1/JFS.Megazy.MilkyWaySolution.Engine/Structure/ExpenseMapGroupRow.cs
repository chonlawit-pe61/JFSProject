...
{
	[Serializable]
	public class ExpenseMapGroupRow
	{
	...
	[Serializable]
	public class ExpenseMapGroupData
	{
		private int _expenseID;
		private int _jFCaseTypeID;
		private string _groupCode;
	...
	[Serializable]
	public class ExpenseMapGroupPaging
	{
		public int totalPage{ get; set; }
		public int totalRow{ get; set; }
		public ExpenseMapGroupRow[] expenseMapGroupRow { get; set; }
	}
	/// <summary>
	/// ส่วนขยายคลาส ExpenseMapGroupItemsPaging เพิ่ม RowRank
	/// </summary>
	[Serializable]
	public class ExpenseMapGroupItems : ExpenseMapGroupData
	{
	...
	/// </summary>
	public class ExpenseMapGroupItemsPaging
	{
		public int totalPage { get; set; }
		public int totalRow { get; set; }
		public ExpenseMapGroupItems[] expenseMapGroupItems { get; set; }
	}
}
