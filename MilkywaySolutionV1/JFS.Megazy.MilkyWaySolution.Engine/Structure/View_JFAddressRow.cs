...
{
	[Serializable]
	public class View_JFAddressRow
	{
	...
	[Serializable]
	public class View_JFAddressData
	{
		private int _addressID;
		private string _address1;
		private string _houseNo;
	...
	[Serializable]
	public class View_JFAddressPaging
	{
		public int totalPage{ get; set; }
		public int totalRow{ get; set; }
		public View_JFAddressRow[] view_JFAddressRow { get; set; }
	}
	/// <summary>
	/// ส่วนขยายคลาส View_JFAddressItemsPaging เพิ่ม RowRank
	/// </summary>
	[Serializable]
	public class View_JFAddressItems : View_JFAddressData
	{
	...
	/// </summary>
	public class View_JFAddressItemsPaging
	{
		public int totalPage { get; set; }
		public int totalRow { get; set; }
		public View_JFAddressItems[] view_JFAddressItems { get; set; }
	}
}
