...
{
	[Serializable]
	public class View_LawyerOfficeAddressRow
	{
	...
	[Serializable]
	public class View_LawyerOfficeAddressData
	{
		private int _lawyerOfficeID;
		private int _addressID;
		private string _address1;
	...
	[Serializable]
	public class View_LawyerOfficeAddressPaging
	{
		public int totalPage{ get; set; }
		public int totalRow{ get; set; }
		public View_LawyerOfficeAddressRow[] view_LawyerOfficeAddressRow { get; set; }
	}
	/// <summary>
	/// ส่วนขยายคลาส View_LawyerOfficeAddressItemsPaging เพิ่ม RowRank
	/// </summary>
	[Serializable]
	public class View_LawyerOfficeAddressItems : View_LawyerOfficeAddressData
	{
	...
	/// </summary>
	public class View_LawyerOfficeAddressItemsPaging
	{
		public int totalPage { get; set; }
		public int totalRow { get; set; }
		public View_LawyerOfficeAddressItems[] view_LawyerOfficeAddressItems { get; set; }
	}
}
