...
{
	[Serializable]
	public class ExpenseMapFinanceRow
	{
	...
	[Serializable]
	public class ExpenseMapFinanceData
	{
		private int _expenseID;
		private int _jFCaseTypeID;
		private bool _isOther;
	...
	[Serializable]
	public class ExpenseMapFinancePaging
	{
		public int totalPage{ get; set; }
		public int totalRow{ get; set; }
		public ExpenseMapFinanceRow[] expenseMapFinanceRow { get; set; }
	}
	/// <summary>
	/// ส่วนขยายคลาส ExpenseMapFinanceItemsPaging เพิ่ม RowRank
	/// </summary>
	[Serializable]
	public class ExpenseMapFinanceItems : ExpenseMapFinanceData
	{
	...
	/// </summary>
	public class ExpenseMapFinanceItemsPaging
	{
		public int totalPage { get; set; }
		public int totalRow { get; set; }
		public ExpenseMapFinanceItems[] expenseMapFinanceItems { get; set; }
	}
}
