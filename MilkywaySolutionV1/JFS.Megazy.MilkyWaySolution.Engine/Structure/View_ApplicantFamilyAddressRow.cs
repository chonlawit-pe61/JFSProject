...
{
	[Serializable]
	public class View_ApplicantFamilyAddressRow
	{
	...
	[Serializable]
	public class View_ApplicantFamilyAddressData
	{
		private int _addressID;
		private string _address1;
		private string _houseNo;
	...
	[Serializable]
	public class View_ApplicantFamilyAddressPaging
	{
		public int totalPage{ get; set; }
		public int totalRow{ get; set; }
		public View_ApplicantFamilyAddressRow[] view_ApplicantFamilyAddressRow { get; set; }
	}
	/// <summary>
	/// ส่วนขยายคลาส View_ApplicantFamilyAddressItemsPaging เพิ่ม RowRank
	/// </summary>
	[Serializable]
	public class View_ApplicantFamilyAddressItems : View_ApplicantFamilyAddressData
	{
	...
	/// </summary>
	public class View_ApplicantFamilyAddressItemsPaging
	{
		public int totalPage { get; set; }
		public int totalRow { get; set; }
		public View_ApplicantFamilyAddressItems[] view_ApplicantFamilyAddressItems { get; set; }
	}
}
