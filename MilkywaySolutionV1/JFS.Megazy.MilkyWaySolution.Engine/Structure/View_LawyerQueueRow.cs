...
{
	[Serializable]
	public class View_LawyerQueueRow
	{
		...
		private bool _queueIDNull = true;
		...
		private bool _queueStatusIDNull = true;
		...
		public int QueueStatusID
		{
			...
			set
			{
				_queueStatusIDNull = false;
				_isSetQueueStatusID = true;
				_queueStatusID = value;
			}
		}
		public bool IsQueueStatusIDNull
		{
			get {
				 return _queueStatusIDNull; }
			set { _queueStatusIDNull = value; }
		}
	...
	[Serializable]
	public class View_LawyerQueueData
	{
		private int _lawyerID;
		private int _lawyerTypeID;
		private string _title;
	...
	[Serializable]
	public class View_LawyerQueuePaging
	{
		public int totalPage{ get; set; }
		public int totalRow{ get; set; }
		public View_LawyerQueueRow[] view_LawyerQueueRow { get; set; }
	}
	/// <summary>
	/// ส่วนขยายคลาส View_LawyerQueueItemsPaging เพิ่ม RowRank
	/// </summary>
	[Serializable]
	public class View_LawyerQueueItems : View_LawyerQueueData
	{
	...
	/// </summary>
	public class View_LawyerQueueItemsPaging
	{
		public int totalPage { get; set; }
		public int totalRow { get; set; }
		public View_LawyerQueueItems[] view_LawyerQueueItems { get; set; }
	}
}
