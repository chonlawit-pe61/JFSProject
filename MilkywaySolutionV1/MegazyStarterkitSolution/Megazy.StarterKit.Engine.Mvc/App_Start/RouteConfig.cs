    ...
    public class RouteConfig
    {
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute(
               ...
               namespaces: new[] { "Megazy.StarterKit.Engine.Mvc.Controllers" },
               constraints: new { lang = new LocalConstraint() });// constraints: new { lang = @"(\w{2})|(\w{2}-\w{2})" },   // en or en-US

            routes.MapRoute("Root", "", new { controller = "Home", action = "Index", id = "" }, new[] { "Megazy.StarterKit.Engine.Mvc.Controllers" });
            routes.MapRoute("home-index", "home/index", new { controller = "Error", action = "NotFound" }, new[] { "Megazy.StarterKit.Engine.Mvc.Controllers" });
